...
func (b *TelegramBot) handleHelpCommand(message *tgbotapi.Message) {
	text := "Подписка, чаты, баллы, события, связь с админом — всё через /start с кнопками.\n\n" +
		...
		"/voteban (reply | @user | <id>) — голосование за кик из чата на час (порог 15% активных за 7 дней, clamp 3-10; симметрия за/против; cooldown 5 мин в чате и 30 мин на инициатора; голосуют только активные за 7 дней)\n\n" +
