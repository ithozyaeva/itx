...
func (b *TelegramBot) handleHelpCommand(message *tgbotapi.Message) {
	text := "Подписка, чаты, баллы, события, связь с админом — всё через /start с кнопками.\n\n" +
		...
		"/voteban (reply) — голосование за кик из чата (5 голосов «за» за 15 мин → кик на час; не чаще раза в 5 мин в чате и раза в 30 мин на инициатора; голосуют только активные за 7 дней)\n\n" +
