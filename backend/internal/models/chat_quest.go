...
type ChatQuest struct {
	...
	AutoGenerated        bool       `json:"autoGenerated" gorm:"column:auto_generated;default:false"`
	NotificationPostedAt *time.Time `json:"notificationPostedAt" gorm:"column:notification_posted_at"`
