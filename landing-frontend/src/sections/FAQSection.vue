...
const questions: Question[] = [
  ...
  },
  {
    ...
    answer: 'Еженедельные онлайн-встречи: английский клуб, технический книжный клуб, лекции по архитектуре, AI и карьерному росту. Также — оффлайн-митапы, мок-интервью, разбор резюме, обмен вакансиями и реферальными ссылками.',
  },
  {
    title: 'Для кого подходит IT-ХОЗЯЕВА?',
    answer: 'Для IT-специалистов любого грейда и направления: разработчики, тестировщики, аналитики, AI-инженеры, DevOps, менеджеры. В сообществе участники из Яндекса, Тинькофф, VK и других компаний — от junior до lead.',
  },
]
</script>
