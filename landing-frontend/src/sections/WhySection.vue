...
const features: Feature[] = [
  {
    ...
    description: 'Участники делятся опытом, разбирают кейсы и помогают друг другу — от вайбкодинга и применения AI в работе до нетворкинга и переговоров по офферу.',
  },
  {
  ...
  },
  {
    ...
    description: 'Английский клуб, технический книжный клуб, лекции по архитектуре, AI и вайбкодингу, soft skills, закрытые тренинги для VIP-участников.',
  },
