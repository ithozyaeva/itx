...
const features: Feature[] = [
  {
    ...
    description: 'Участники делятся опытом, разбирают кейсы и помогают друг другу — от выбора стека и применения AI в работе до переговоров по офферу.',
  },
  {
  ...
  },
  {
    ...
    description: 'Английский клуб, технический книжный клуб, лекции по архитектуре, AI и soft skills, закрытые тренинги для VIP-участников.',
  },
    ...
    <div class="container px-6 md:px-10 flex flex-col gap-10">
      <div class="flex flex-col gap-5 text-center lg:flex-row lg:flex-auto lg:text-start justify-between">
        ...
        <Typography
          ...
          class="basis-1/2"
        >
          IT-ХОЗЯЕВА — это 250+ IT-специалистов, которые помогают друг другу расти: менторство, AI-практики, совместная подготовка к собеседованиям, обмен вакансиями, еженедельные встречи и обучение.
        </Typography>
      </div>
