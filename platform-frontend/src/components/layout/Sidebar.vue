...
<template>
  <div>
    <div
      ...
      class="fixed md:static h-[calc(100dvh-var(--safe-y))] border-r border-sidebar-border bg-sidebar text-sidebar-foreground transition-all duration-300 w-full md:w-56 z-40"
      :class="[
