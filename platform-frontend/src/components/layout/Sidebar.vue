...
<template>
  <div>
    <div
      ...
      class="fixed inset-y-0 left-0 md:static md:h-[calc(100dvh-var(--safe-y))] pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)] md:p-0 border-r border-sidebar-border bg-sidebar text-sidebar-foreground transition-all duration-300 w-full md:w-56 z-50"
      :class="[
