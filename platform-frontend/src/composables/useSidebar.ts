...
import { Award, BarChart3, BookOpen, Calendar, ClipboardList, FileText, Flame, Folder, Gift, Heart, Home, MessageSquare, Shield, ShoppingBag, Star, Trophy, Users } from 'lucide-vue-next'
import { ref } from 'vue'
