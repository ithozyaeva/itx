  ...
  <div class="container mx-auto px-4 py-6 md:py-8 max-w-3xl">
    ...
    <template v-else-if="data">
      ...
      <!-- Onboarding-блок «как заработать»: показываем тем, у кого нет
           транзакций ИЛИ пустой баланс — иначе они не поймут, как пополнить.
           Реф-программа платформы — личный deeplink в боте (/referral),
           отдельно от legacy реферальных ссылок на вакансии (/referals),
           которые в кредиты больше не конвертируются. -->
      <div
      ...
      <EmptyState
        ...
        description="Пригласите участника по личной ссылке — +30 кредитов за каждого."
      />
